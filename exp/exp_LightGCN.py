...
class Exp_LightGCN():
    def __init__(self, args):
        ...
        self.model = LightGCN(args=self.args, dataset=trainMat).to(self.device)
    ...
    def train(self):
        ...
        for user, item_p, item_n in train_loader:
            ...
            bpr_loss, reg_loss = self.model.calculate_loss(user, item_p, item_n)

            loss = bpr_loss + self.args.coef_reg * reg_loss
    ...
    def val(self, dataloader):
        hit_ratio, NDCG = [], []
        user_embedding, item_embedding = self.model()
